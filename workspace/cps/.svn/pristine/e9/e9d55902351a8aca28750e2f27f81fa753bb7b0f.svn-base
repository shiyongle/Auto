  ...
  <body>
    <div id="raise">
       	<form id="updateForm" method="post" action="${ctx}/address/update.net" >
           	...
           	<table >
			    <tr>
					<td class="m-info-title">收货人<span class="red">*</span>:</td>
				...
				<tr>
					<td class="m-info-title">收货地址<span class="red">*</span>:</td>
					...
					$.post(url,$("#updateForm").serialize(),function(data){
					 		if(data=="success"){
					 			parent.layer.alert('操作成功！', function(alIndex){
					 				parent.document.getElementById("iframepage").contentWindow.gridUaddressTable(1);
