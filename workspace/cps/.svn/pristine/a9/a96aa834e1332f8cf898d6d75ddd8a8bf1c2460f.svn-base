...
import com.util.SmsClientAccessTool;
...
public class SmsClientSend {
	 ...
	 */
	public static String sendSms(String url,String action,String userid, String account,
			String password, String mobile, String content,String extno) {

		return sendSms(url,action,userid, account, password, mobile, content,extno,"",
				 "POST", "UTF-8", "UTF-8");
	}
	 ...
	 * @return 返回发送之后收到的信息
	 */
	private static String sendSms(String url, String action, String userid, String account,
			String password, String mobile, String content,String extno,
		...
		try {
			...
			send.append("&extno=").append(
					URLEncoder.encode(extno, codingType));
