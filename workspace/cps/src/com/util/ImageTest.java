...
//            encoder.finish();
    ...
    public static void main(String[] args) throws Exception {
        ...
        try {
            ...
            targetPath = ImageTest.cutImage(file.getPath(), targetPath, x , y , width, height);
            
            String bigTargetPath = pathPrefix  + System.currentTimeMillis() + pathSuffix;
            ImageTest.zoom(targetPath, bigTargetPath, 100, 100);
            
            String smallTargetPath = pathPrefix  + System.currentTimeMillis() + pathSuffix;
            ImageTest.zoom(targetPath, smallTargetPath, 50, 50);
