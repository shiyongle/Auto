			...
			$.ajaxFileUpload({
				...
				success: function (response){
					if(response.success){
						...
						layer.alert('上传失败！', function(index){layer.close(index);});
					}
				},
				error:function (){
					layer.alert('上传失败！', function(index){layer.close(index);});
        	 ...
        	 <p class="p1">需求信息</p>
                ...
                <table cellpadding="0" cellspacing="0" border="0" width="550">
                	<tr height="50">
                        ...
                        <td width="185"><input type="text" id="fname" name="fname" class="_require"/></td>
                        <td align="right" width="90">订单数量:</td>
                        <td>
                           	<input id="min_quantity" type="button" value="－" class="reduce" />
                           	<input id="amount" type="text" value="1" class="amount" name="famount"/>
                    ...
                    <tr height="50">
                        ...
                        <td>
                        	...
                        	<a href="javascript:void(0);" class="_no _color" id="no_" onclick="isYes(0);">否</a>
                        </td>
                    </tr>
                    <tr height="50">
                    	<td align="right" width="90">入库日期<span class="red">*</span>:</td>
                        <td width="185">
                        		<input type="text" id="foverdate" name="foverdate" class="_date" readonly="readonly" onfocus="WdatePicker({dateFmt:'yyyy-MM-dd HH:mm:ss',minDate:'${firstday}',maxDate:'${lastday}'})" value="${foverdate}"/>
                                <a class="for_date"><img  onclick="WdatePicker({el:$dp.$('foverdate'),dateFmt:'yyyy-MM-dd HH:mm:ss',minDate:'${firstday}',maxDate:'${lastday}'})"   src="${ctx}/css/images/sj.png"/></a>
                        </td>
                        <td align="right" width="90">发货日期<span class="red">*</span>:</td>
                        <td width="185">
                        		<input type="text" id="farrivetime" name="farrivetime" class="_date" readonly="readonly" onfocus="WdatePicker({dateFmt:'yyyy-MM-dd HH:mm:ss',minDate:'${firstday}',maxDate:'${lastday}'})" value="${foverdate}"/>
                                <a class="for_date"><img  onclick="WdatePicker({el:$dp.$('farrivetime'),dateFmt:'yyyy-MM-dd HH:mm:ss',minDate:'${firstday}',maxDate:'${lastday}'})" src="${ctx}/css/images/sj.png"/></a>
                        </td>
                    </tr>
                    <tr height="50">
                    	<td width="82" align="right">联系人:</td>
                        <td width="180"><input type="text" class="_require" id="flinkman" name="flinkman" value="${flinkman}"/></td>
                        <td width="82" align="right">联系电话:</td>
                        <td width="180"><input type="text"  class="_require" id="flinkphone" name="flinkphone" value="${flinkphone}"/></td>
                    </tr>
                    <tr height="80">
                    	<td align="right">需求描述<span class="red">*</span>:</td>
                        <td colspan="3"><textarea id="fdescription" name="fdescription" class="description" placeholder="填写包装要求、特殊要求、现状问题、填写内容具体、准确、设计效率越高" style="font-size:13px"></textarea></td>
                    </tr>
                </table>
            </div>
            <div class="div3">
