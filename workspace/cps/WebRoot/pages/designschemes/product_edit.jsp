...
<link rel="stylesheet" type="text/css"
	href="${ctx}/pages/designschemes/css/publish_edit.css" />
<script type="text/javascript" language="javascript"
	src="${ctx}/js/jquery.form.js"></script>
<script type="text/javascript" language="javascript"
	src="${ctx}/js/webuploader-0.1.5/webuploader.js"></script>
<script type="text/javascript" language="javascript"
	src="${ctx}/pages/designschemes/js/publish_edit.js"></script>

<title>作品编辑</title>
</head>
<body>
	<div id="container">
		<p class="p1">平台首页 > 用户中心 >作品编辑</p>
		<div class="publish_main">
			<div class="publish_tip1">
				Hi,<span id="userName">${designscheme.fsuppliername}</span>，请确认您拥有该作品的版权；带有<font
					class="red">*</font>的项目都是必填的哦。
			</div>
			<div class="publish_form">
				<form id="publish_pro" method="post">
					<div class="pro_div1">
						<div class="publish_pro_left">
							作品名称<span class="red">*</span>
						</div>
						<div class="publish_pro_right">
							<input type="hidden" id="fid" name="designscheme.fid"
								value="${designscheme.fid}" /> <input type="text" id="pro_name"
								name="designscheme.fname" value="${designscheme.fname}"
					...
					<div class="pro_div2">
						<div class="pro_div2_01">
							...
							<div class="publish_pro_right">
								<textarea id="pro_detial" name="designscheme.fdescription"
									onkeyup="wordDetial_check()" maxlength="200">${designscheme.fdescription}</textarea>
							</div>
						</div>
							...
							<div class="pro_img_list">
								<ul>
									...
									<c:forEach var="entry" items="${imglist}" varStatus="status">
										<li id="IMG_LI_EDIT_${status.index}"><img
											src="/cps/productfile/getFileByImageId.net?fid=${entry.fid }"
											id="${entry.fid}" />
										<div class="close"></div>
											<textarea type="text" class="pro_img_ms"
												placeholder="这里是图片描述......">${entry.fdescription}</textarea></li>
									</c:forEach>
								</ul>
							</div>
					...
					<div class="pro_div6">
						...
						<div class="publish_pro_right">
							<div class="pro_type">
							<input type="hidden" value="${designscheme.ftype}" id="selectType"/>
								<select name="designscheme.ftype" >
					...
					<div class="pro_div4">
						...
						<div class="publish_pro_right">
							...
							<input type="hidden" value="${designscheme.fauthtype}" id="selectAuthtype"/>
								<select name='designscheme.fauthtype'>
					...
					<div class="pro_div5">
						<a class="pro_img_a" href="javascript:void(0)"
							onclick="edit(this)">确定</a> <a class="pro_img_a"
