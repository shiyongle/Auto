...
#header{width:1280px;height:100px;background:#fff;position:relative;font-size:14px;font-family:微软雅黑;font-weight:bold;color:#34495E;}

#top{width:1280px;height:80px;padding-top:10px;}
.top_left{float:left;}
#top a{color:#34495E;}
#top a:hover{color:#d70c19;}

#logo{width:360px; height:80px;float:left;border-right:2px solid #ddd;}
#logo img{display:block;width:140px;height:40px;padding:10px 100px;}
#logo span{width:340x;font-family:宋体;color:#3d3d3d;text-align:center;letter-spacing:3px;padding:0 5px; }
...
#top .link a{display:block;float:left;padding:0 32px;line-height:85px;color:#34495E;}
#top .link a:hover{color:#d70c19;}
...
#nav_onlinedesign .addDemand{display:block;width:140px;height:100px;background:#fff ;margin:auto ;height:32px;line-height:32px;text-align:center;cursor:pointer;color:#7A8E9D;}
#nav_onlinedesign .addDemand:hover {color:red;}
...
#top .anewwelcom:hover,#top .anewreg:hover{color:#d70c19;}
</style>
</head>
<body>
<div id="header">
...
<div class="top_left">
        <div id="logo">
    	<img src="${ctx}/css/images/logo_red.png" alt="logo" />
    	<span >打造中小企业降本提效，价值倍增第一平台</span>
    	</div>
        <s:if test="#session.user == null">
		         <img src="${ctx}/css/images/index_03.png" class="ico"></img>
		         <a class="anewwelcom" style="margin-left:0; color:red;" >登录</a>
		         <a class="anewreg">立即注册</a>          		 	
         </s:if>
       	 <s:else>
	       		<img src="${ctx}/css/images/index_03.png" class="ico" style=";margin-right:-35px;"></img>
       ...
       <div class="link">
        	...
        	<a  onclick="lineDesgin();"style="color:#d70c19; cursor:pointer;" >用户中心</a>
        	
            <a href="javascript:void(0)" id="nav_onlinedesign">
            	在线设计<span style="color:#7A8E9D;">﹀</span>
