...
<html>
  ...
  <body>
    <div id="raise">
       	<form id="createForm" method="post" action="${ctx}/address/save.net" >
           	...
           	<table >
			    <tr>
					...
					<td class="m-info-content"><input type="text" id="fname" name="address.flinkman"/></td>
					<td class="m-info-title">电话<span class="red">*</span>:</td>
					<td class="m-info-content"><input type="text" id="fphone" name="address.fphone"/></td>
				</tr>

				<tr>
					<td class="m-info-title">详细地址<span class="red">*</span>:</td>
					<td class="m-info-content" colspan="3"><textarea id="fdetailaddress" name="address.fdetailaddress" style="width:396px;height:80px;"></textarea></td>
				</tr>
				<tr>
					<td colspan="2">
						<div class="Mbutton25 saveButton" id="saveButton">保存</div>
					</td>
					<td colspan="2">
