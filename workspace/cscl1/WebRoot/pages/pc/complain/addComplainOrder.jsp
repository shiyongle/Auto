	...
	$(document).ready(function() {
		...
		$("#searchOrderNum").combobox({
			...
			onSelect:function(item){
				   var jsonNum={"orderId":item.optionId};
				   $.ajax({
						type : "POST",
						...
						success : function(response) {
							...
							$("#cusBalance").val(jsRes.cusBalance);
							$("#driBalance").val(jsRes.driBalance);
						}
					});
		...
		$("#saveDriverAndShipper").click(function() {
			...
			if ($("#complainForm").form("validate")) {
				...
				$.ajax({
					type : "POST",
					url : "${ctx}/usercomplain/saveComplain.do",
					data : params,
					success : function(response) {
						if(response == "success") {
...
<legend><strong><h3>投诉记录</h3></strong></legend>
			...
			<tr><td colspan="6" height="10px"></td></tr>
				<tr>
					...
					<select id="searchOrderNum" name="forderId" class="easyui-combobox" panelHeight="200" >
					</select>
					
					<strong style="margin-left:24px;">投诉人<span class="red">*</span>：</strong>
					<input  type="text" id="fcomplainUserName" name="fcomplainUserName" style="width:110px;"  class="easyui-validatebox"  required="true"   missingMessage="客户名称必须填写" />
					
					<strong style="margin-left:24px;">投诉类型<span class="red">*</span>：</strong>
					<select id="fcomplainType" name="fcomplainType" class="easyui-combobox">
			    ...
			    style="width:300px;height:100px;resize:none;border:1px solid #ccc"></textarea>
			    <td class="m-info-title" >沟通记录：</td>
			    <td class="m-info-content" colspan="3">
			    <textarea  id="fcomplainCommunicateContent" name="fcomplainCommunicateContent" 
			    style="width:320px;height:100px;resize:none;border:1px solid #ccc"></textarea>
			    </td>
			    </tr>			
			</table>
	</fieldset>
...
<legend><strong><h3>司机处理结果</h3></strong></legend>
			<table>
				<tr><td height="10px"></td></tr>
				<tr>
				<td colspan="4"><strong><h3>金额扣除：</h3></strong></td>
				</tr>
				...
				<tr>
					...
					<td class="m-info-content">
					<input  type="text" id="resultDriverName"  style="width:92px;" disabled="disabled" />
					</td>
					<td class="m-info-title" style="padding-left:10px">扣除金额：</td>
					<td class="m-info-content">
					<input  type="text" class="easyui-numberbox" precision="2" id="fdriverFineAmount" name="fdriverFineAmount" style="width:90px;"/> 元
					</td>
			    </tr>
			    <tr>
			    	<td class="m-info-title">司机余额：</td>
					<td class="m-info-content">
					<input  type="text" id="driBalance"  style="width:92px;" disabled="disabled" />
					</td>
			    </tr>   
			    <tr><td height="10px"></td></tr>
			    <tr>
				<td colspan="4">
				<strong>是否禁号：</strong>
				是<input type="radio" id="accountArohibitYes" name="fdriverAccountDisable" value=1 >
				否<input type="radio" id="accountArohibitNo" name="fdriverAccountDisable" value=0 checked="checked">
				<input type="text" id="fdriverAccountDisableStart" disabled="disabled" class="datePicker MtimeInput" onfocus="WdatePicker({dateFmt:'yyyy-MM-dd HH',maxDate:'#F{$dp.$D(\'fdriverAccountDisableEnd\')}'})" name="fdriverAccountDisableStart" value="" /> -
				<input type="text" id="fdriverAccountDisableEnd" disabled="disabled" class="MtimeInput" onfocus="WdatePicker({dateFmt:'yyyy-MM-dd HH',minDate:'#F{$dp.$D(\'fdriverAccountDisableStart\')}'})" name="fdriverAccountDisableEnd" value="" />
				</td>
				</tr>
				<tr><td height="10px"></td></tr>
			    <tr>
				<td colspan="4">
				<strong>是否冻结：</strong>
				是<input type="radio" id="accountFrozenYes" name="fdriverFreezeDisable" value=1>
				否<input type="radio" id="accountFrozenNo" name="fdriverFreezeDisable" value=0 checked="checked">
				<input type="text" id="fdriverFreezeDisableStart" disabled="disabled" class="datePicker MtimeInput" onfocus="WdatePicker({dateFmt:'yyyy-MM-dd HH',maxDate:'#F{$dp.$D(\'fdriverFreezeDisableEnd\')}'})" name="fdriverFreezeDisableStart" value="" /> -
				<input type="text" id="fdriverFreezeDisableEnd" disabled="disabled" class="MtimeInput" onfocus="WdatePicker({dateFmt:'yyyy-MM-dd HH',minDate:'#F{$dp.$D(\'fdriverFreezeDisableStart\')}'})" name="fdriverFreezeDisableEnd" value="" />
				</td>
				</tr>
				...
				<td class="m-info-title">司机名称：</td>
				<td class="m-info-content">
				<input  type="text" id="subsidyDriverName"  style="width:92px;" disabled="disabled"/>
				</td>
				<td class="m-info-title">返还金额：</td>
				<td class="m-info-content">
				<input  type="text" id="subsidyPrice" name="fdriverRewardAmount"  style="width:80px;" class="easyui-numberbox" precision="2"/> 元
				</td>
				</tr>
				<tr><td height="10px"></td></tr>
				...
				<textarea placeholder="" id="driverRemarks" name="fdriverRemark" style="width:370px;height:100px;resize:none;border:1px solid #ccc">
</textarea>
				</td>
				</tr>
...
<legend><strong><h3>货主处理结果</h3></strong></legend>
			<table>
				<tr><td height="10px"></td></tr>
				<tr>
				<td colspan="4"><strong><h3>退返费用：</h3></strong></td>
				</tr>
				<tr><td height="5px"></td></tr>
				<tr>
					<td class="m-info-title">货主姓名：</td>
					<td class="m-info-content">
					<input  type="text" id="resultShipperName"  style="width:92px;" disabled="disabled" />
					</td>
					<td class="m-info-title" style="padding-left:6px">返还金额：</td>
					<td class="m-info-content">
					<input  type="text" id="resultShipperDedMoney" name="fshipperFineAmount" style="width:100px;" class="easyui-numberbox" precision="2" style="width:90px;"/> 元
					</td>
			    </tr>
			    <tr>
			    	<td class="m-info-title">货主余额：</td>
					<td class="m-info-content">
					<input  type="text" id="cusBalance"  style="width:92px;" disabled="disabled" />
					</td>
			    </tr>   
			   <tr><td height="10px" colspan="4"><hr style="border:0px;border-bottom:1px dashed #ccc; padding-top:5px;"/></td></tr>
				<tr>
				...
				<tr>
					...
					<td class="m-info-content">
					<input  type="number" id="shipperCouponsNum"  disabled="disabled" name="fshipperRewardCouponsAmount"  style="width:75px;" class="easyui-numberbox"/> 张
					</td>
					<td class="m-info-title" style="padding-left:10px">面额：</td>
					<td class="m-info-content">
					<input  type="text" disabled="disabled" id="shipperCouponsPrice" name="fshipperRewardCouponsDollars"  style="width:100px;" class="easyui-numberbox" precision="2"/> 元
					</td>
			    </tr> 
			    <tr>
			    <td class="m-info-title">期限:</td>
				<td class="m-info-content" colspan="3">
				<input type="text" style="width:138px" id="fshipperRewardCouponsStart" disabled="disabled" class="datePicker MtimeInput" onfocus="WdatePicker({dateFmt:'yyyy-MM-dd HH',maxDate:'#F{$dp.$D(\'fshipperRewardCouponsEnd\')}'})" name="fshipperRewardCouponsStart" value="" /> -
				<input type="text" style="width:138px" id="fshipperRewardCouponsEnd" disabled="disabled" class="MtimeInput" onfocus="WdatePicker({dateFmt:'yyyy-MM-dd HH',minDate:'#F{$dp.$D(\'fshipperRewardCouponsStart\')}'})" name="fshipperRewardCouponsEnd" value="" />
				</td>
				</tr>
				...
				<tr>
				<td class="m-info-content" colspan="4">
				<textarea placeholder="" id="shipperRemarks" name="fshipperRemark" style="width:370px;height:100px;resize:none;border:1px solid #ccc">
</textarea>
				</td>
				</tr>
<!-- 			  	<tr><td height="10px"></td></tr>	 -->
...
<button class="Mbutton25 createButton" id="saveDriverAndShipper" align="center" style="margin-right:8px;border:0px">保存</button>
</div>
</form>
