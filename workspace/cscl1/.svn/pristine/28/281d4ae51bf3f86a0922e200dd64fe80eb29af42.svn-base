...
<legend><strong><h3>司机处理结果</h3></strong></legend>
			<table>
				...
				<tr>
					...
					<td class="m-info-content">
					<input  type="text" class="easyui-numberbox" precision="2" id="fdriverFineAmount" name="fdriverFineAmount" value="${ccinfo.fdriverFineAmount}"  style="width:90px;"/> 元
					</td>
			    </tr> 
			    <tr>
			    	<td class="m-info-title">司机余额：</td>
					<td class="m-info-content">
					<input  type="text" id="cusBalance"  style="width:92px;" disabled="disabled" value="${ccinfo.cusBalance}"/>
					</td>
			    </tr>    
			    <tr><td height="10px"></td></tr>
			    <tr>
				...
				<td class="m-info-content">
				<input  type="text" id="subsidyPrice" name="fdriverRewardAmount" value="${ccinfo.fdriverRewardAmount}" style="width:80px;" class="easyui-numberbox" precision="2"/> 元
				</td>
				</tr>
				<tr><td height="10px"></td></tr>
...
<legend><strong><h3>货主处理结果</h3></strong></legend>
			<table>
				...
				<tr>
					...
					<td class="m-info-content">
					<input  type="text" id="resultShipperDedMoney" name="fshipperFineAmount" value="${ccinfo.fshipperFineAmount}" style="width:100px;" class="easyui-numberbox" precision="2" style="width:90px;"/> 元
					</td>
			    </tr>
			    <tr>
			    	<td class="m-info-title">货主余额：</td>
					<td class="m-info-content">
					<input  type="text" id="driBalance"  style="width:92px;" disabled="disabled" value="${ccinfo.driBalance}" />
					</td>
			    </tr>   	
			   <tr><td height="10px" colspan="4"><hr style="border:0px;border-bottom:1px dashed #ccc; padding-top:5px;"/></td></tr>
				<tr>
