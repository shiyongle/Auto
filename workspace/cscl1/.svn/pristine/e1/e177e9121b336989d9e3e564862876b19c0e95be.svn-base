			...
			<div class="row">
				...
				<div class="col-lg-5 col-lg-offset-4 col-md-5 col-md-offset-4 col-sm-6 col-sm-offset-3 col-xs-12">	
					<div class="form-group myform">
						<input type="password" class="form-control form-register key_img" id="pass_word0" placeholder="输入您的原始密码">
						<a class="tooltip-hide" id="password0_err" data-toggle="tooltip" data-placement="right" title="请输入原始密码"></a>
						<a class="tooltip-hide" id="password0_err2" data-toggle="tooltip" data-placement="right" title="原始密码错误"></a>
					</div>
				</div>
				<!-- 新密码 -->
				<div class="col-lg-5 col-lg-offset-4 col-md-5 col-md-offset-4 col-sm-6 col-sm-offset-3 col-xs-12">	
				...
				<div class="col-lg-5 col-lg-offset-4 col-md-5 col-md-offset-4 col-sm-6 col-sm-offset-3 col-xs-12">	
					<div class="form-group myform">
						...
						<a class="tooltip-hide" id="password2_err2" data-toggle="tooltip" data-placement="right" title="两次密码不同"></a>
						<a class="tooltip-hide" id="password1_err3" data-toggle="tooltip" data-placement="right" title="密码为6-8位的数字字母组合"></a>
						<!-- 提示 -->
					</div>
				</div>
	...
	$.ajax({
		...
		success:function(response){
			...
			if(response.success=="false"){
				...
				location.href="${ctx}/pages/pcWeb/pass_word/password_succeed.jsp";
			}
		}
	});
}
