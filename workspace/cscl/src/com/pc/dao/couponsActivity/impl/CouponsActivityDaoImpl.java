...
public class CouponsActivityDaoImpl extends BaseDao<CL_CouponsActivity, Integer> implements
	...
	@Override
	public List<CL_CouponsActivity> getAllTopUpActivity(int factivityType,int feffective) {
		HashMap<String, Object> map = new HashMap<>();
		map.put("factivityType", factivityType);
		map.put("feffective", feffective);
		return this.getSqlSession().selectList(getIbatisSqlMapNamespace() + ".getAllTopUpActivity", map);
	}
