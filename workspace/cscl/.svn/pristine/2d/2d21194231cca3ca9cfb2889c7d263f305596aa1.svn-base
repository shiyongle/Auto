	...
	$(document).ready(function() {
		...
		$("#saveDriverAndShipper").click(function() {
			...
			if ($("#complainForm").form("validate")) {
				...
				if($("#shipperCo uponsPrice").val()!=""&&$("#shipperCouponsNum").val()==""){
...
<legend><strong><h3>司机处理结果</h3></strong></legend>
			<table>
				...
				<tr>
					...
					<td class="m-info-content">
					<input  type="text"  id="fdriverFineAmount" name="fdriverFineAmount" style="width:90px;"/> 元
					</td>
			    </tr>
			    <tr>
				...
				<td class="m-info-content">
				<input  type="text" id="subsidyPrice" name="fdriverRewardAmount"  style="width:80px;"/> 元
				</td>
				</tr>
				<tr><td height="10px"></td></tr>
...
<legend><strong><h3>货主处理结果</h3></strong></legend>
			<table>
				...
				<tr>
					...
					<td class="m-info-content">
					<input  type="text" id="resultShipperDedMoney" name="fshipperFineAmount" style="width:100px;"style="width:90px;"/> 元
					</td>
			    </tr>
			    <tr>
