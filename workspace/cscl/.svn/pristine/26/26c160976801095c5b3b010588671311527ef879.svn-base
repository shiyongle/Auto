...
<head>
    ...
    <script type="text/javascript" src="${ctx}/pages/pcWeb/js/zero_for_payment.js"></script>
</head>
<body>
    ...
    <div class="body_info jumbotron">
        <div>
            <div class="row">
                ...
                <div class="col-xs-12 col-md-3 message">
                <span>
                    <span class="text-warning">零担</span>
        ...
        <div class="row">
            <div class="col-xs-12" style="margin-bottom: 20px; text-align: right;">
                <button type="button" class="btn btn-danger  btn-single">立即评价</button>
