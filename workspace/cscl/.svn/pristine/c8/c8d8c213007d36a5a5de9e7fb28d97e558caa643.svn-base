...
<html lang="zh-CN">
  ...
  <meta charset="utf-8">
    ...
    <link href="${ctx}/pages/pcWeb/css/identity_company.css" rel="stylesheet">
    ...
    <script src="${ctx}/pages/pcWeb/js/identity_company.js"></script>
    <!--[if lt IE 9]>
...
<%@ include file="/pages/pcWeb/top/top.jsp"%>
	...
	<div class="gray_bg">
			<div class="row">
				<div class="col-xs-6 text-center  person"><a href="identity_person.jsp">个人用户</a></div>
				<div class="col-xs-6 text-center company red_bg" ><a href="javascript:void(0)">企业用户</a></div>
			</div>
	</div>	
	...
	<form id="inden_form">
		...
		<div class="col-xs-12 col-md-6 col-md-offset-3 ">
			<div class="form-group form_warp">
				<input type="text" class="form-control form-commomText iden_img" id="iden" name="iden" placeholder="上传营业执照、组织机构代码"  onFocus="this.blur()">
			</div>
		</div>
		</div>
		<!--样图-->
		...
		<div class="col-xs-12 text-center col-md-3 col-md-offset-3">
			<img id="img1" src="${ctx}/pages/pcWeb/css/images/register_iden/licenceCode.png" class="center-block"/>营业执照
		...
		<div class="col-xs-12 text-center col-md-3">
			<img id="img2" src="${ctx}/pages/pcWeb/css/images/register_iden/organizationCode.png" class="center-block"/>组织机构代码
...
<!-- 			<a class="btn btn-danger btn_ignore" id="ignore" href="register_success.jsp">跳过</a> -->
			<a class="btn btn-danger btn_next" id="finish" href="javascipt:void(0)">下一步</a>
		</div>	
		</div>
		</form>
	</div>
