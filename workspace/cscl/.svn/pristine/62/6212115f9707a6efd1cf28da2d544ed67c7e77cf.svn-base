package com.pc.query.couponsActivity;
...
public class CouponsActivityQuery extends BaseQuery implements Serializable {
	...
	private Integer factivityType;//活动类型：0指派（发放人群） 1充值送
	private BigDecimal ftopUpDollars;//充值的金额
	private Integer feffective;//活动有效与否 1有效  2无效  3过期
	...
	private int fuseTime;//有效期（天）
	private BigDecimal fdollars;//满足金额条件
	private Integer fcarSpecId;//满足车型条件
	...
	public Integer getFcarSpecId() {
		return fcarSpecId;
	}
	public void setFcarSpecId(Integer fcarSpecId) {
