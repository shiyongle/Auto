...
<head>
    ...
    <script type="text/javascript" src="${ctx}/pages/pcWeb/js/vehicle_transportation.js"></script>
</head>
<body>
...
<div class="body">
    <div class="body_info jumbotron">
        <div>
            <div class="row">
                ...
                <span>
                    ...
                    <span class="text-warning">运输中</span>
                </span>
                </div>
            </div>
        </div>
        ...
        <hr>
        <div class="row">
            <div class="col-xs-12 btn-position" >
                <button type="button" class="btn btn-danger btn-single">追加款</button>
            </div>
        </div>
