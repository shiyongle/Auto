/*
 * ! jquery.base64.js 0.0.3 - https://github.com/yckart/jquery.base64.js Makes
		...
		encode : function(strUni) {
			...
			var strUtf = strUni.replace(/[\u0080-\u07ff]/g, // U+0080 - U+07FF
					...
					function(c) {
						...
						return String.fromCharCode(0xc0 | cc >> 6, 0x80 | cc
										& 0x3f);
					}).replace(/[\u0800-\uffff]/g, // U+0800 - U+FFFF => 3
													// bytes 1110xxxx, 10yyyyyy,
													// 10zzzzzz
					function(c) {
						var cc = c.charCodeAt(0);
