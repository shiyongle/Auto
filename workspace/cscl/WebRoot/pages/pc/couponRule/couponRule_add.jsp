	...
	<form id="TForm"  >
			<table class="add-user" id="createBursarInfo">
				<tr>
					...
					<td class="m-info-content"><input  type="text" name="dollars"  class="easyui-numberbox" required="true" missingMessage="面额必须填写"/> </td>
				</tr>
				<tr>
					<td class="m-info-title">比面额<span class="red">*</span>:</td>
					<td class="m-info-content"><input  type="text" name="compareDollars"  class="easyui-numberbox" required="true" missingMessage="比面额必须填写"/> </td>
				</tr>
				<tr>
				    <td class="m-info-title">消费面额<span class="red">*</span>:</td>
					<td class="m-info-content"> <input  type="text" name="consumption" class="easyui-numberbox" required="true" missingMessage="消费面额必须填写"/></td>
