...
<div  id="createWindow"> </div>
	<form id="addForm">
		<input name="ftype" value="1"/>
			<table class="add-user" id="createBursarInfo">
				<tr>
					<td class="m-info-title">增值服务名称<span class="red">*</span>:</td>
					<td class="m-info-content">
						<input name="faddserviceName"  class="easyui-validatebox" data-options=" required:true,validType:['maxLength[10]'], missingMessage:'增值服务必须填写！！'">
					</td>
				</tr>
				<tr>
					<td class="m-info-title">增值服务价格<span class="red">*</span>:</td>
					<td>
						<input  type="text"  name="faddservicePrice" class="easyui-numberbox"  data-options="required:true,missingMessage:'增值服务价格！',validType:['maxLength[15]']" />
					</td>
				</tr>
				<tr>
					<td class="m-info-title">备注<span class="red">*</span>:</td>
					<td class="m-info-content">
						<textarea name="fremark"  class="easyui-validatebox" data-options=" required:true,validType:['maxLength[50]'], missingMessage:'备注必须填写！！'"></textarea>
					</td>
				</tr>
			</table>
