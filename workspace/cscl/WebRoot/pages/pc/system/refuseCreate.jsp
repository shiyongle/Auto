		...
		<table>
			<tr>
				...
				<td class="m-info-content">
					<input type="text" name="StartTime" class="easyui-validatebox datePicker MtimeInput"  style="width:200px;" id="startTime" name="useStartTime" onclick="WdatePicker({dateFmt:'yyyy-MM-dd HH:mm:ss',maxDate:'#F{$dp.$D(\'endTime\')}'})">
				</td>
			</tr>
			<tr>
				<td class="m-info-title">结束时间:</td>
				<td class="m-info-content">
					<input type="text"  name="EndTime" class="easyui-validatebox MtimeInput"  id="endTime" style="width:200px;" name="useEndTime" onclick="WdatePicker({dateFmt:'yyyy-MM-dd HH:mm:ss',minDate:'#F{$dp.$D(\'startTime\')}'})">
				</td>
			</tr>
			<tr>
			...
			<tr>
				...
				<td class="m-info-content">
					<input type="text" id="policeTips" style="width:200px;" name="fkey">
				</td>
			</tr>
		</table>
