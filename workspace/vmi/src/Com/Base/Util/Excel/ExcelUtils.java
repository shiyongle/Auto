...
public class ExcelUtils {
	...
	public static Workbook getWorkBook(InputStream inp) throws IOException{
	    ...
	    if (POIXMLDocument.hasOOXMLHeader(inp)) {
	        try {
				...
				throw new DJException("你的excel版本目前无法解析");
			}
	    }
	    return null;
	}
	 ...
	 * @throws IOException
	 */
	public static Workbook getWorkBook(HttpServletRequest request) throws IOException{
	 ...
	 * @throws IOException
	 */
	public static List<Workbook> getWorkBooks(HttpServletRequest request) throws IOException{
		DiskFileItemFactory factory = new DiskFileItemFactory(); 
		ServletFileUpload upload = new ServletFileUpload(factory);
		List<FileItem> fileItemList = null;
	 ...
	 * @throws IOException
	 */
	public static Sheet getSheet(HttpServletRequest request) throws IOException{
	 ...
	 * @throws IOException
	 */
	public static List<Sheet> getSheets(HttpServletRequest request) throws IOException{
	 ...
	 * @return
	 */
	public static List<Sheet> getSheets(List<Productdemandfile> fileList) {
	...
	public static Date convertStringToDate(String val){
		...
		if(date==null){
			...
			try {
				...
				throw new DJException("日期格式不正确，请更改！");
			}
		}
		return date;
	}
