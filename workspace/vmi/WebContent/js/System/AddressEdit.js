...
Ext.define('DJ.System.AddressEdit', {
...
//								allowBlank : false,
								...
								listeners : {
									...
									// {
									// fprovinceid :
									// Ext.getCmp("DJ.System.AddressEdit.fprovinceid").getValue()//
									// obj.data[0].fprovinceid
									// }
									// );
									// },
									select : function(_combo, _record, _opt) {
...
//								regex : /^([\u4E00-\u9FA5]|\w|[()\-])*$/,			// /^[^,\!@#$%^&*()_+}]*$/,
								...
								listeners : {
									...
									// store.proxy.extraParams,{
									// fcountryid :
									// Ext.getCmp("DJ.System.AddressEdit.fcountryid").getValue()
									// }
									// );
									// },
									select : function(_combo, _record, _opt) {
								...
								// {
								// fcityidid :
								// Ext.getCmp("DJ.System.AddressEdit.fcityidid").getValue()//
								// obj.data[0].fprovinceid
								// });
								// }
								// }
