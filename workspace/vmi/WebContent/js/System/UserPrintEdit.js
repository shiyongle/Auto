...
Ext.define('DJ.System.UserPrintEdit', {
	extend : 'Ext.c.BaseEditUI',
	id : "DJ.System.UserPrintEdit",
	modal : true,
	onload : function() {
		// 加载后事件，可以设置按钮，控件值等
	...
	resizable : false,
	url : 'SaveCustomerUser.do',
	infourl : 'GetCustUserInfo.do', // 指定界面数据获取，combobox根据name+"_"+valueField赋隐藏值，name+"_"+displayField赋显示值;在SQL查询的时候需要自己构建
	viewurl : 'GetCustUserInfo.do', // 查看状态数据源
