...
Ext.define('DJ.System.product.productpriceEdit', {
	extend : 'Ext.c.BaseEditUI',
	id : 'DJ.System.product.productpriceEdit',
	modal : true,
	title : "产品结算界面",
	ctype : "Balanceprice",
	...
	resizable : false,
	url : 'SaveBalanceprice.do',
	infourl : 'getBalancepriceInfo.do',
	viewurl : 'getBalancepriceInfo.do',
	...
	initComponent : function() {
		Ext.apply(this, {
			items : [{
				...
				xtype : 'cTable',
				name : "Balancepriceprices",
				id : "DJ.System.product.productpriceEdit.prices",
				// title:"测试",
				// collapsible:true,
				...
				height : 200,
				pageSize : 100,
				url : "GetBalancepricepricesList.do",
				...
				xtype : 'cTable',
				name : "Balancepricecustprices",
				id : "DJ.System.product.productpriceEdit.custprices",
				width : 775,
				height : 200,
				pageSize : 100,
				url : "GetBalancepricecustpricesList.do",
				parentfield : "e.fproductid",
				plugins : [Ext.create('Ext.grid.plugin.CellEditing', {
					clicksToEdit : 1
				})],
				...
				columns : [{
					...
					editor : {
						...
						MyDataChanged : function(com) {
							var row = Ext
									.getCmp("DJ.System.product.productpriceEdit.custprices")
