...
Ext.define('DJ.finance.Gathering.GatheringList', {
			extend : 'Ext.c.GridPanel',
			title : "帐户支出",
			id : 'DJ.finance.Gathering.GatheringList',
			pageSize : 50,
			closable : true,// 是否现实关闭按钮,默认为false
			url : 'GetGatheringList.do',
			Delurl : "",//DelTruckassembleList.do
			EditUI : "DJ.finance.Gathering.GatheringEdit",
			exporturl:"GatheringtoExcel.do",//导出为EXCEL方法
			onload : function() {
				// 加载后事件，可以设置按钮，控件值等
//				alert("DeliverList");
//				Ext.getCmp("DJ.finance.Gathering.GatheringList.addbutton").setVisible(false);
				Ext.getCmp("DJ.finance.Gathering.GatheringList.editbutton").setVisible(false);
				Ext.getCmp("DJ.finance.Gathering.GatheringList.delbutton").setVisible(false);
			},
...
//					}
			...
			columns : [
					...
					},
					{
						...
						'header' : '要货申请单号',
						'dataIndex' : 'deliverapplynum',
						sortable : true
					},
					{
						'header' : '出库单号',
						'dataIndex' : 'saledelivernum',
						sortable : true
					}, {
						'header' : '客户产品',
						'dataIndex' : 'custproductname',
						sortable : true
					}, {
						'header' : '发货数量',
						'dataIndex' : 'FAMOUNT',
