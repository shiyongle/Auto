...
public class login extends UiAutomatorTestCase {
	public void testlogin() throws UiObjectNotFoundException,RemoteException{
		...
		System.out.println("knowlages power");             //判断父级对象是否存在
		...
		assertTrue("There has not be found",view1.exists());	//判断父级对象是否存在
		...
		System.out.print("Knowledges powers");		//判断父级对象是否存在
		...
		assertTrue("There has not be found",data.exists());			//判断父对象是否存在
